        ...
        <div className='mt-[9rem] mx-14 mb-[3rem] max-md:mt-[7rem] max-md:mx-8'>
            ...
            <div className='pt-[2rem] flex flex-col gap-3 max-md:pt-[1rem]'>
                ...
                <div className='space-y-3'>
                    ...
                    <p className='pl-8 leading-8'>This policy applies to all users of services provided by <strong>SkyGoal Innova Technologies Private Limited</strong>, including website visitors, customers, and partners, whose personal information is collected, stored, or processed by us. </p>
                </div>

                <div className='space-y-3'>
                    <h4 className='text-xl font-medium'>3. Data That Can Be Deleted</h4>
                    <p className='leading-8'>Subject to applicable law, users may request deletion of the following types of data:
                    </p>
                    <ul className='list-disc pl-8 leading-8'>
                    ...
                    <p className='leading-8'>Note: We may retain certain information as required by law, regulation, or for legitimate business purposes (e.g., fraud prevention, audit logs, tax or billing records).</p>
                </div>

                <div className='space-y-3'>
                    <h4 className='text-xl font-medium'>4. How to Request Data Deletion</h4>
                    <p className='leading-8'>To request the deletion of your personal data, please contact us through one of the following methods:
                    </p>
                    <ul className='list-disc pl-8 leading-8'>
                        <li>Full name</li>
                ...
                <div className='space-y-3'>
                    ...
                    <p className='leading-8'>You will receive a confirmation once your data has been deleted or a reason if the deletion cannot be completed.</p>
                </div>

                <div className='space-y-3'>
                    <h4 className='text-xl font-medium'>6. Exceptions
                    </h4>
                    <p className='pl-8 leading-8'>We may retain personal data under the following circumstances:
                    </p>
                    <ul className='list-disc pl-8 leading-8'>
                ...
                <div className='space-y-3'>
                    ...
                    <p className='pl-8 leading-8'>If your data is stored or processed by third-party service providers or integrated platforms (e.g., cloud storage, CRM tools), we will forward your deletion request to those providers, as applicable, or guide you on how to contact them directly.
                    </p>
                </div>
                ...
                <div className='space-y-3'>
                    ...
                    <p className='pl-8 leading-8'>We may update this Data Deletion Policy periodically. Any changes will be posted on this page with an updated "Effective Date." We encourage users to review this policy regularly.
                    </p>
                </div>
                ...
                <div className='space-y-3'>
                    ...
                    <p className='pl-8 leading-8'>If you have any questions or concerns about Data Deletion Policy, please contact us:
                    </p>
