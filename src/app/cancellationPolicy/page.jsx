...
export default function page() {
    return (
        <div className='mt-[9rem] mx-14 mb-[3rem] max-md:mt-[7rem] max-md:mx-8'>
            ...
            <h3 className='text-3xl font-semibold'>Cancellation Policy</h3>
            <div className='pt-[2rem] flex flex-col gap-3 max-md:pt-[1rem]'>

                <p className='leading-8'>At <strong>SkyGoal Innova Technologies Private Limited</strong> we are dedicated to ensuring customer satisfaction and aim to maintain a fair and transparent cancellation process. In line with this commitment, we have adopted a customer-friendly yet structured cancellation policy, as outlined below:</p>
                ...
                <div className='flex flex-col gap-4'>
                    ...
                    <div className='space-y-3'>
                        ...
                        <p className='pl-8 leading-8'>Cancellations will only be considered if the request is submitted within <strong>24 hours of placing the order</strong>. Requests made after this period may not be accepted, as the order processing may already be underway.
                        </p>
                    </div>
                    ...
                    <div className='space-y-3'>
                        ...
                        <p className='pl-8 leading-8'> If an order has already been communicated to our operations team and the execution process has begun, such cancellation requests will not be entertained. Once the assignment process is initiated, the order is considered final and non-cancellable.
                        </p>
                    </div>
                    ...
                    <div className='space-y-3'>
                        ...
                        <p className='pl-8 leading-8'> In exceptional cases such as duplicate payments or technical errors, cancellation and refund requests will be reviewed by our support team on a case-by-case basis. Approval in such cases is at the sole discretion of <strong>SKYGOAL INNOVA TECHNOLOGIES PRIVATE LIMITED</strong> and subject to verification and internal approval procedures.
                        </p>
                    </div>
                    ...
                    <div className='space-y-3'>
                        ...
                        <p className='pl-8 leading-8'>If you have any questions or concerns about Cancellation Policy, please contact us:
                        </p>
