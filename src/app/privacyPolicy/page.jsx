    ...
    return (
        <div className='mt-[-7rem] mx-14 mb-[3rem]'>
            ...
            <div className='pt-[2rem] flex flex-col gap-3'>
                ...
                <div className='space-y-3'>
                    <h4 className='text-xl font-medium'>1. Information We Collect
                    </h4>
                ...
                <div className='space-y-3'>
                    ...
                    <ul className='list-disc pl-8'>
                        ...
                        <li>To send you updates, promotional materials, or newsletters (you can opt-out anytime)
                        </li>
                ...
                <div className='space-y-3'>
                    ...
                    <ul className='list-disc pl-8'>
                        ...
                        <li>Right to object to or restrict data processing
                        </li>
